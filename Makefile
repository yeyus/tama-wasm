...
EXPORTFLAGS += -sEXPORTED_FUNCTIONS=_void_tama_step,_void_tama_button,_u32t_tama_run_for,_u8tp_tama_get_memory,_main -sEXPORTED_RUNTIME_METHODS=ccall,cwrap
